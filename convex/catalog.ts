...
export const importDigaCatalogRefs = registeredFunctions.catalog.importDigaCatalogRefs;
...
export const lookupDigaByPzn = registeredFunctions.catalog.lookupDigaByPzn;
