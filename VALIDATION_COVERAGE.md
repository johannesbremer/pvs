...
- `eVDGA`
  ...
  - the published negative PKV example is asserted to fail with executable validation
- `KVDT`
...
- `eVDGA`
  - workflow-backed and executable coverage exercises:
    ...
    - mirrored official positive example sweeps plus the published negative PKV example
